...
parser.add_argument("--log_dir", type=str, default='data/reduced')
...
parser.add_argument("--num_src_radius", type=int, default=2)
parser.add_argument("--min_src_radius", type=float, default=0.06)
parser.add_argument("--max_src_radius", type=float, default=0.1)
